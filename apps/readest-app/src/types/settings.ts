 ...
 */
/**
 * Credentials for the Groq-backed translation provider. BYO-key: the app
 * calls Groq's API directly from the client with the user's own key, so
 * there's nothing here beyond the key itself and which model to use.
 */
